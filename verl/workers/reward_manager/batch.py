...
class BatchRewardManager(AbstractRewardManager):
    ...
    def verify(self, data):
        ...
        data_sources = data.non_tensor_batch['lang']
        extras = data.non_tensor_batch.get("extra_info", [None] * len(data))

        scores, embed_scores, consistency_scores = self.compute_score(
        ...
        return scores, embed_scores, consistency_scores
    ...
    def __call__(self, data: DataProto, return_dict: bool = False) -> torch.Tensor | dict[str, Any]:
        ...
        scores, embed_scores, consistency_scores = self.verify(data)
        rewards = []
        ...
        for i in range(len(data)):
            ...
            reward_extra_info['embedding_score'].append(embed_scores[i])
            reward_extra_info['consistency_score'].append(consistency_scores[i])
