    ...
    if min_num_params > 0:
        ...
        for layer_class in fsdp_transformer_layer_cls_to_wrap:
            ...
            if transformer_cls is None:
                if layer_class == "SiglipVisionEmbeddings" or layer_class == "SiglipEncoderLayer" or layer_class == "SiglipMultiheadAttentionPoolingHead":
                    print(f"Skip {layer_class} because this model has no vision tower.")
                    continue
